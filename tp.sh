...
declare -A download_links=(
  ...
  ["https://cnam-my.sharepoint.com/personal/jessie_bertanier_lecnam_net/_layouts/15/download.aspx?SourceUrl=%2Fpersonal%2Fjessie%5Fbertanier%5Flecnam%5Fnet%2FDocuments%2FSCENAR%2Egz"]="File 3 (Text format)"
)
